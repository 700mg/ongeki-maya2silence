...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'  => '楽曲一覧',
            'route' => "admin.songs.list",
            'icon'  => 'fas fa-fw fa-list',
        ],
        [
            'text'  => '楽曲登録',
            'route' => "admin.songs.viewRegist",
            'icon'  => 'fas fa-fw fa-plus',
        ],
        [
            'text'  => 'ジャケット一覧',
            'route' => "admin.songs.jacket",
        ...
        [
            'text' => 'お知らせ登録',
            'route' => 'admin.news.registView',
            'icon' => 'fas fa-fw fa-plus',
        ],
        ['header' => 'その他'],
        [
            'text' => 'ブックマークレット',
            'icon' => 'fas fa-fw fa-js',
            'submenu' => [
                [
                    'text' => '一覧',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    "icon" => "",
                    'shift' => 'ml-3',
                    'route'  => ["main.table", ["lv" => "11"]]
                ],
                [
                    'text' => 'Lv12',
                    "icon" => "",
                    'shift' => 'ml-3',
                    'route'  => ["main.table", ["lv" => "12"]]
                ],
                [
                    'text' => 'Lv13',
                    "icon" => "",
                    'shift' => 'ml-3',
                    'route'  => ["main.table", ["lv" => "13"]]
                ],
                [
                    'text' => 'Lv14',
                    "icon" => "",
                    'shift' => 'ml-3',
                    'route'  => ["main.table", ["lv" => "14"]]
                ],
            ],
        ],
        [
