...
@section('content')
    <div class="d-flex justify-content-between p-1">
        <a href="{{ route('admin.bookmarklet.list') }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-left-fill" viewBox="0 0 16 16">
                <path d="m3.86 8.753 5.482 4.796c.646.566 1.658.106 1.658-.753V3.204a1 1 0 0 0-1.659-.753l-5.48 4.796a1 1 0 0 0 0 1.506z"></path>
            </svg>
            リストへ戻る
        </a>
        <form id="news_delete" method="post" action="{{ route('admin.bookmarklet.delete') }}">
            @csrf
    ...
    <div class="section">
        ...
        @endif
        <form class="main_form" method="post" action="{{ route('admin.bookmarklet.update') }}">
            @csrf
            <fieldset disabled>
                <input type="hidden" name="id" value="{{ $bookmarklet->id }}">
                <div class="form-group row mb-3">
                    <label for="inputTitle" class="col-sm-2 col-form-label">見出し</label>
                    <div class="col-sm-10">
                        <input type="text" name="header" class="form-control" id="inputHeader" placeholder="見出し" value="{{ $bookmarklet->header }}">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" name="contents" class="form-control" id="inputContents" placeholder="本文">{{ $bookmarklet->contents }}</textarea>
